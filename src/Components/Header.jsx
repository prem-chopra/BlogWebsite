...
export const Header = () => {
  ...
  const { isLogin, getValue } = context;
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <Link to="/" className=" items-center font-bold">
          HOME
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link to="/dashboard" className="flex items-center font-bold " onClick={handledashboard}>
          {isLogin ? "PREM" : "DASHBOARD"}
        </Link>
      </Typography>
      <Typography
        as="li"
      ...
      >
        ...
        <Link to="/allblogs" className="flex items-center font-bold">
          BLOGS
        </Link>
      </Typography>
    </ul>
  ...
  return (
    <>
      <Navbar className="  min-w-full px-4 py-2 lg:px-8 lg:py-4 ">
        <div className=" flex items-center justify-between text-blue-gray-900">
         <Link to="/">
         <Typography
            as="a"
            href="#"
            className="mr-4 cursor-pointer py-1.5  text-2xl font-bold italic"
          >
            MYBLOG
          </Typography>
         </Link>
            ...
            {navList}
              <div className="flex items-center gap-x-1">
                <Button fullWidth variant="text" size="sm" className="">
                  {
                    isLogin?<Link to="/"><span onClick={Logout}> LOgout</span></Link>:<Link to="/adminlogin"><span>Login</span></Link>
                  }
                </Button>
              </div>
          </div>
